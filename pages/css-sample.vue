<template lang="pug">
  .container
    ...
    // .style-2
    //   svg(width="860" height="575" viewBox="0 0 860 575")
    //     img(v-bind="{'xlink:href': require('~/assets/css-sample/img/sample.jpg')}" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" clip-path="url(#clip01)")
    //   svg(width="0" height="0" style="position: absolute; top: 0; left: 0;")
    //     clipPath(id="clip01")
    //       polygon(points="0.5,0 860.5,233 859.5,575 0.5,343")      
